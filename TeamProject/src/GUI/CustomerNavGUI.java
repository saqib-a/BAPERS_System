 ...
 * @author sajawal
 */
public class CustomerNavGUI extends javax.swing.JFrame {

    /**
     * Creates new form CustomerNavGUI
     */
    public CustomerNavGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        createstaffAccountlabel.setText("Customer Account Navigation");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(createstaffAccountlabel, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(layout.createSequentialGroup()
                .addGap(161, 161, 161)
   ...
   if(st.getJobTitle().equals("Office Manager") ){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        UpdateCustomerAccount v = new UpdateCustomerAccount();
        v.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        DeleteCustomerAccount v = new DeleteCustomerAccount();
        v.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerNavGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerNavGUI().setVisible(true);
            }
        });
    }
